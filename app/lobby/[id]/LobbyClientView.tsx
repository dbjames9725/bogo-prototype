...
export default function LobbyClientView({ lobbyId }: { lobbyId: string }) {
  ...
  useEffect(() => {
    ...
    // Subscribe to real-time updates for this specific lobby record
  ...
  return (
    <div className="max-w-2xl mx-auto p-4 sm:p-6 bg-white rounded-xl shadow-md border border-gray-100">
